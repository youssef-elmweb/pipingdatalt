    ...
    return  (
        <View style={[ {justifyContent: "center", alignItems: "center"} ]}>
            <Modal style={[ {justifyContent: "center", alignItems: "center"} ]} animationType={"fade"} transparent={true} visible={props.statusModalSettings}>
                <Pressable style={[ {width: width, height: height, justifyContent: 'space-between', alignSelf: "center", alignItems: 'center', opacity: (height > 650 ? 0.9 : 0.97), backgroundColor : "#151515"} ]} onPressOut={ props.makeStatusModalSettings }>
                    <Pressable style={[ {width: (width*0.9), height: (Platform.OS != "ios" ? (width*0.9)+80 : (width)+80), marginTop: (Platform.OS != "ios" ? (height*0.25) : (height*0.1)), paddingBottom: 13, justifyContent: 'space-between', alignSelf: "center", alignItems: 'center', borderRadius: 5, backgroundColor : "#3b3b3b"} ]} onTouchEnd={ (e) => e.stopPropagation() }>
