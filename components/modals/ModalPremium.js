                        ...
                        <View style={[ {width: width, height: Number(height*0.915), flexDirection: "column", justifyContent: "flex-start", alignItems: "center", backgroundColor: "transparent"} ]}>
                            ...
                            <View style={[ { height: height*0.225, flexDirection: "column", justifyContent: "space-between", alignItems: "center", backgroundColor: "transparent"} ]}>                                 
                                <View style={{ alignItems: "center" }}>
                                    <Text style={{ color: "white", fontSize: height * 0.015, marginBottom: height * 0.0025, letterSpacing: 0.5 }}>{functions.firstLetterToUpperCase(languages[0][props.idLanguage].premium_launch_offer)}</Text>
                                    ...
                                    <Pressable style={{ width: width * 0.85, justifyContent: "center", alignSelf: "center", alignItems: "center", borderWidth: 2.5, borderColor: "silver", borderRadius: 25, backgroundColor: 'green' }} onPress={() => Linking.openURL('https://play.google.com/store/apps/details?id=com.production.pipingdata&hl=fr')}>
                                        <Text style={{ width: width * 0.85, height: width * 0.075, marginVertical: height * 0.0125, lineHeight: width * 0.075, fontSize: width * 0.05, fontWeight: "bold", textAlign: "center", letterSpacing: 1.5, color: "white" }}>{`PRO 0.99 €`}</Text>
                                    </Pressable>
                                </View>
